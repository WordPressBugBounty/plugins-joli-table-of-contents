...
<div id="wpj-jtoc" class="wpj-jtoc wpj-jtoc--main <?php echo esc_attr($in_the_content) ?><?php echo esc_attr($toc_wrapper_shared_classes) ?><?php echo esc_attr($toc_wrapper_main_classes) ?><?php echo esc_attr($hidden_main_toc) ?>" <?php echo $toc_style ?><?php if (! empty($content_selector)): ?> data-content-selector="<?php echo esc_attr($content_selector) ?>"<?php endif; ?>>
  <!-- TOC -->
